...
for (const coll of ['history', 'events', 'albums', 'committee', 'culture', 'donations', 'transparency', 'announcements', 'members', 'notices', 'roster', 'pages', 'errors']) {
...
await db.doc('albums/a1').set({ ...base, title: bi('২০২৫ পুজো', 'Puja 2025'), year: 2025, coverUrl: 'https://placehold.co/400x300', order: 2025000, published: true, featured: true });
