...
export const PAGE_DEFAULTS = {
  privacy: {
    ...
    body: bi(
      ...
      '<h4>আপনার ডিভাইসে কী রাখা হয়</h4>' +
      '<ul>' +
      '<li>থিম ও ভাষার পছন্দ — ব্রাউজারের localStorage-এ।</li>' +
      '<li>অফলাইনেও পাতা দেখার জন্য একটা কপি — ব্রাউজারের service worker cache-এ।</li>' +
      ...
      '<h4>What is stored on your device</h4>' +
      '<ul>' +
      '<li>Your theme and language preference — in the browser\'s localStorage.</li>' +
      '<li>A copy of pages for offline viewing — in the browser\'s service-worker cache.</li>' +
