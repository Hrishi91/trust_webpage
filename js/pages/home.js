  ...
  if (events !== null) {
    ...
    const donateBand = () => {
      ...
      return el('section', { class: 'donate' }, el('div', { class: 'wrap' },
        el('div', {}, el('span', { class: 'eyebrow', text: t('nav.donate') }), el('h2', {}, t('home.donateHeading'), el('em', { text: t('home.donateHeadingEm') })),
    ...
    const membersTeaser = () => s.sectionVisibility.members === false ? null : el('section', {}, el('div', { class: 'wrap members' },
      el('div', {}, el('span', { class: 'eyebrow', text: t('mem.title') }), el('h2', { text: t('home.membersHeading') }),
